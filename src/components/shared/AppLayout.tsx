...
const AppLayout = ({ children }: any) => {
  return (
    ...
    <div className="w-full max-w-[1728px] m-auto relative overflow-hidden min-h-screen">
      {/* Gradients as Images */}
      <img src="/grad1.svg" className="absolute -bottom-32 -left-44 w-[40%] opacity-40" alt="Gradient 1" />
      <img src="/grad1.svg" className="absolute top-0 -right-[20rem] w-[35%] opacity-40" alt="Gradient 2" />
